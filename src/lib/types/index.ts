...
export type {
  ...
  TypeSpgrRecruitingSpecialistFields,
} from './TypeSpgrRecruitingSpecialist';
export type { TypeSpgrSection, TypeSpgrSectionFields } from './TypeSpgrSection';
export type { TypeSpgrSingleJob, TypeSpgrSingleJobFields } from './TypeSpgrSingleJob';
export type {
  TypeSpgrSingleJobLocal,
